...
import 'package:my_staff_book/data/local/entity/employee_address.dart';
import 'package:my_staff_book/data/local/entity/employee_entity.dart';
...
class AppDb extends _$AppDb {
  ...
  Stream<List<EmployeeAddressData>> getEmployeeAddress(int id) {
    return (select(employeeAddress)..where((tbl) => tbl.employee.equals(id))).watch();
  }

  // get the list of address
  Stream<List<EmployeeAddressData>> getEmployeeAddressList() {
